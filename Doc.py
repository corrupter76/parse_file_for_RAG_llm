# Solution 2: Using a different approach with AutoModelForSeq2SeqLM
import os
from transformers import AutoModelForSeq2SeqLM

# Try using the PegasusTokenizer directly from the transformers library
...
# Then continue with your text processing code
